...
public class DonatieRepo implements  DonatieRepoI {
    ...
    public DonatieRepo(Properties prop, CazRepo cazRepo, DonatorRepo donatorRepo) {
    ...
    public Donatie save(Donatie entity) {
        ...
        try(PreparedStatement statement = con.prepareStatement
                ("insert into donatie(id,id_caz,id_donator,suma) values (?,?,?,?)")){

            statement.setInt(1,entity.getId());
            statement.setInt(2,entity.getCaz().getId());
            statement.setInt(3,entity.getDonator().getId());
            statement.setInt(4,entity.getSuma_donata());
