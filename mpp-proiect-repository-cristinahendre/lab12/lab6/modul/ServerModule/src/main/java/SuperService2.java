...
public class SuperService2 implements IServiceAM {
    //modul de server
    ...
    private Map<Integer, Integer> donatii;
    private Map<Integer,Integer> users;



    public SuperService2(CazRepoI cazRepo, DonatorRepoI donatorRepo, DonatieRepoI donatieRepo, VoluntarRepoI voluntarRepo,
    ...
    @Override
    public synchronized Voluntar login(String e, String p) throws ServiceException {
        System.out.println("sunt in metoda login(super service)!!!!");
        Voluntar acesta = voluntarRepo.getVoluntarDupaDate(e,p);
        users.put(acesta.getId(),acesta.getId());
    ...
    @Override
    public synchronized void logout(Voluntar user) throws ServiceException {
    ...
    @Override
    public synchronized  void saveDonatie(Donatie don) {
        ...
        donatii.put(aceeasi.getId(), aceeasi.getId());
        notificationService.refresh(aceeasi);
